...
public class InventoryProvider extends ContentProvider {
    ...
    static {
        // The content URI of the form "content://com.kikisnight.inventoryapp/inventory" will map
        // to the integer code {@link #INVENTORY}. This URI is used to provide access to MULTIPLE
        // rows of the inventory table.
        sUriMatcher.addURI(InventoryContract.CONTENT_AUTHORITY, InventoryContract.PATH_INVENTORY, INVENTORY);

        // The content URI of the form "content://com.kikisnight.inventoryapp/inventory/#" will map to the
        // integer code {@link #INVENTORY_ID}. This URI is used to provide access to ONE single row
        // of the products in the inventory table.
        //
        // In this case, the "#" wildcard is used where "#" can be substituted for an integer.
        // For example, "content://com.kikisnight.inventoryapp/inventory/3" matches, but
        // "content://com.kikisnight.inventoryapp/inventory" (without a number at the end) doesn't match.
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case INVENTORY:
                ...
                // could contain multiple rows of the products in the inventory table.
                cursor = database.query(InventoryEntry.TABLE_NAME, projection, selection, selectionArgs,
                        null, null, sortOrder);
                break;
            case INVENTORY_ID:
                // For the INVENTORY_ID code, extract out the ID from the URI.
                // For an example URI such as "content://com.kikisnight.inventoryapp/inventory/3",
    ...
    private Uri insertInventory(Uri uri, ContentValues values) {
        ...
        if (supplier == null) {
            throw new IllegalArgumentException("Product requires the name of the supplier");
        }

        String email = values.getAsString(InventoryEntry.COLUMN_INVENTORY_EMAIL);
        if (email == null) {
            throw new IllegalArgumentException("Product requires the email of the supplier");
        }

        // If the price is provided, check that it's greater than or equal to 0 units
    ...
    private int updateInventory(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        // If the {@link InventoryEntry#COLUMN_INVENTORY_EMAIL} key is present,
